...
.data
    ...
    msg_ingresar_indice db 13,10,'Ingrese indice (1-15): $'
    msg_indice_invalido db 13,10,'Indice invalido. Presione cualquier tecla...$'
...
mostrar_estudiante_indice proc
    push ax
    push bx
    push cx
    push dx
    ...
    ; Mostrar "Nombre: "
    mov dx, offset msg_nombre_nota
    mov ah, 09h
    int 21h
    
    ; Calcular offset del nombre (índice * 20)
    xor ax, ax
    mov al, bl
    mov cl, 20
    mul cl
    ...
    ; Mostrar " - Nota: "
    mov dx, offset msg_nota
    mov ah, 09h
    int 21h
    
    ; Obtener y mostrar nota
    lea si, notas
    xor ax, ax
    mov al, bl
    add si, ax
    ...
    pop ax
    ret
mostrar_estudiante_indice endp

; Procedimiento para imprimir campo (cadena terminada en '$')
print_field proc
    push ax
    push dx
    push si
